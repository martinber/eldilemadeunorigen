Juego.Escena_n_1 = function (game) {
	
};

Juego.Escena_n_1.prototype = {
	create: function () {
	...
	crearDialogo: function () {
		this.dialogo = new Dialogo(this, datosJSON.escena_n_1.dialogos.dialogo1); // Crear dialogo
		this.foco = false;
	},
	...
	avanzarEscena: function() {
		this.limpiar();
		game.state.start('Escena-n-2'); // Ir a escena
	},
