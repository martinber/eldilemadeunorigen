Juego.Escena_1s_1 = function (game) {
	
};

Juego.Escena_1s_1.prototype = {
	create: function () {
	...
	crearDialogo: function () {
		this.dialogo = new Dialogo(this, datosJSON.escena_1s_1.dialogos.dialogo1); // Crear dialogo
		this.foco = false;
	},
	...
	eliminarDialogo: function () {
		...
		this.dialogo = null;
		this.decision = new Decision(this, "Escena-1s-1"); // Crear decision
		this.foco = false;
	},
