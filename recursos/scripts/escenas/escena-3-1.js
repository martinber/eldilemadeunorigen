Juego.Escena_3_1 = function (game) {
	
};

Juego.Escena_3_1.prototype = {
	create: function () {
	...
	listo: function () { // Cuando termina la transicion
		this.foco = true;
		this.alarma = game.time.events.add(Phaser.Timer.SECOND * .5, this.crearDialogo, this);
	},
	...
	crearDialogo: function () {
		this.dialogo = new Dialogo(this, datosJSON.escena_3_1.dialogos.dialogo1); // Crear dialogo
		this.foco = false;
	},
	...
	avanzarEscena: function() {
		this.limpiar();
		game.state.start('Escena-3-2'); // Ir a escena
	},
